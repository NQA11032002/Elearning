    ...
    <div class="Container w-[100%]">
        ...
        <table class="Table">
            ...
            <tr>
                ...
                <td class="tableItems">
                    <div class="text-center"> <a @click="handleNavigation('LessonsPage')" class="cursor-pointer"><button class="border border-black rounded-lg bg-orange-400"><span
                                class="mx-3">Chi tiết</span></button></a></div>
                </td>
                <td class="tableItems">
