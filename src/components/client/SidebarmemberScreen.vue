<template>
    <div class="w-1/5 h-full  bg-white rounded-xl max-sm:w-full">
        <div class="grid grid-cols-gridTable justify-center w-full py-4 border-b border-gray-100">
            ...
            <div>
                <span class="font-semibold px-2">Hồ Quang Đạt</span>
            </div>
            <div>
                <span class="font-normal px-2 text-gray-500 text-sm">Học viên</span>
            </div>
        </div>
        <div class="flex flex-col items-left ml-6">
            ...
            <div class="flex items-left py-4">
                ...
                <a class="text-blue-900 cursor-pointer items-center justify-center flex text-center font-medium" href="">Hỗ trợ</a>
            </div>
            <div class="flex items-left py-4">
                <i class="fa-solid fa-gift text-xl mr-3 text-blue-900"></i>
                <a class="text-blue-900 cursor-pointer items-center justify-center flex text-center font-medium" href="">Kích hoạt mã</a>
            </div>
            <div class="flex items-left py-4">
                <i class="fa-solid fa-gift text-xl mr-3 text-blue-900"></i>
                <a class="text-blue-900 cursor-pointer items-center justify-center flex text-center font-medium" href="">Quản lý</a>
            </div>
            <div class="flex items-left py-4">
                <i class="fa-solid fa-arrow-right-from-bracket text-xl mr-3 text-blue-900"></i>
                <a class="text-blue-900 cursor-pointer items-center justify-center flex text-center font-medium" href="">Đăng xuất</a>
            </div>
        </div>
    </div>
</template>
