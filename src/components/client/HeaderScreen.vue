        ...
        <div v-if="isAuthenticated" class="">
          <div  class="flex items-center gap-4 ">
            <div class="">
              ...
              <a href="/my-course" class="font-medium border border-blue-900 text-blue-900  py-1 px-4 rounded-md transition-all hover:bg-blue-900 hover:text-white">Quản lý</a>
