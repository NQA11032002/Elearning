        ...
        <div class="p-4">
          ...
          <div class="flex justify-between mt-4 max-sm:flex-col">
            <div
              ...
              <a href="/changepass"><span class="text-blue-900 font-medium flex items-center">Đổi mật khẩu</span></a>
...
export default {
  ...
  methods: {
    updateInformation() {
      ...
      updateInfor(this.user.userID ,this.user.fullName, this.user.email, this.user.phone).then((data) => {
        if (data.status === 'OK') {
